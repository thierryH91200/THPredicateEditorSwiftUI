...
//        // Handle CAST('...', 'NSDate')
//        if trimmed.uppercased().hasPrefix("CAST(") {
//            // Extract between first single quote and the next single quote
//            if let firstQuote = trimmed.firstIndex(of: "'"),
//               let secondQuote = trimmed[trimmed.index(after: firstQuote)...].firstIndex(of: "'") {
//                let dateStr = String(trimmed[trimmed.index(after: firstQuote)..<secondQuote])
//                // Try multiple formats commonly used in NSPredicate examples
//                let fmts = ["MM/dd/yyyy HH:mm", "MM/dd/yyyy", "yyyy-MM-dd"]
...
//            }
//        }
//        // Handle quoted ISO-like date literals 'yyyy-MM-dd' or "yyyy-MM-dd"
//        var literal = trimmed
//        if (literal.hasPrefix("'") && literal.hasSuffix("'")) || (literal.hasPrefix("\"") && literal.hasSuffix("\"")) {
//            literal = String(literal.dropFirst().dropLast())
//        }
//        let fmts = ["yyyy-MM-dd", "MM/dd/yyyy HH:mm", "MM/dd/yyyy"]
//        let df = DateFormatter()
//        df.locale = Locale(identifier: "en_US_POSIX")
//        for f in fmts {
//            df.dateFormat = f
//            if let d = df.date(from: literal) { return d }
//        }
//        return nil
//    }
//
