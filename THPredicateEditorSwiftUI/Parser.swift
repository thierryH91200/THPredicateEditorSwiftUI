...
//        let defaultFormat = "firstName ==[cd] 'John' OR lastName ==[cd] 'doe' OR (dateOfBirth <= CAST('11/18/2018 00:00', 'NSDate') AND dateOfBirth >= CAST('01/01/2018', 'NSDate')) OR country ==[cd] 'United States' OR age = 25"
    ...
    func seedData() {
        ...
        let date2 = Date() - 25.years
        let date3 = Date() - 26.years
        let date4 = Date() - 27.years
        let date5 = Date() - 28.years
        let date6 = Date() - 29.years
        let date7 = Date() - 30.years
        person = [
            ...
            EntityPerson(firstName: "John", lastName: "Leo", dateOfBirth: date7, age: 30, department: "Finance", country: "Brazil", isBool: false)
    ]
        for p in person {
